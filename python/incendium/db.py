...
def _execute_sp(stored_procedure, database='', transaction=None, skip_audit=False, in_params=None,
                out_params=None, get_out_params=False, get_result_set=False, get_ret_val=False,
    ...
    Args:
        ...
        get_out_params (bool): A flag indicating whether or not to return OUTPUT
        ...
        get_ret_val (bool): A flag indicating whether or not to return the return
