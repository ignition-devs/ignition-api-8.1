...
def format(date: Date, format: Union[str, unicode] = ...) -> unicode: ...
...
def getTimezone() -> Union[str, unicode]: ...
...
def now() -> Date: ...
def parse(
    dateString: Union[str, unicode],
    formatString: Union[str, unicode] = ...,
    locale: Union[str, unicode, Locale] = ...,
) -> Date: ...
