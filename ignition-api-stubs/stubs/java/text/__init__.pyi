...
class Format(Object):
    ...
    def parseObject(
        self, source: Union[str, unicode], pos: Optional[ParsePosition] = ...
    ) -> Object: ...
...
class DateFormat(Format):
    ...
    ) -> Union[str, unicode, StringBuffer]: ...
    @staticmethod
    ...
    def parse(self, source: Union[str, unicode]) -> Date: ...
...
class DateFormatSymbols(Object):
    ...
    def clone(self) -> Object: ...
    def getAmPmStrings(self) -> List[Union[str, unicode]]: ...
    @staticmethod
    def getAvailableLocales() -> List[Locale]: ...
    def getEras(self) -> List[Union[str, unicode]]: ...
    @staticmethod
    def getInstance(locale: Optional[Locale] = ...) -> DateFormatSymbols: ...
    def getLocalPatternChars(self) -> Union[str, unicode]: ...
    def getMonths(self) -> List[Union[str, unicode]]: ...
    def getShortMonths(self) -> List[Union[str, unicode]]: ...
    def getShortWeekdays(self) -> List[Union[str, unicode]]: ...
    def getWeekdays(self) -> List[Union[str, unicode]]: ...
    def getZoneStrings(self) -> List[List[Union[str, unicode]]]: ...
    def setAmPmStrings(self, newAmpms: List[Union[str, unicode]]) -> None: ...
    def setEras(self, newEras: List[Union[str, unicode]]) -> None: ...
    def setLocalPatternChars(
        self, newLocalPatternChars: Union[str, unicode]
    ) -> None: ...
    def setMonths(self, newMonths: List[Union[str, unicode]]) -> None: ...
    def setShortMonths(self, newShortMonths: List[Union[str, unicode]]) -> None: ...
    def setShortWeekdays(self, newShortWeekdays: List[Union[str, unicode]]) -> None: ...
    def setWeekdays(self, newWeekdays: List[Union[str, unicode]]) -> None: ...
    def setZoneStrings(
        self, newZoneStrings: List[List[Union[str, unicode]]]
    ) -> None: ...
...
class NumberFormat(Format):
    ...
    def parse(self, source: Union[str, unicode]) -> Number: ...
...
class SimpleDateFormat(DateFormat):
    def __init__(
        self,
        pattern: Union[str, unicode, None] = ...,
        arg: Union[DateFormatSymbols, Locale, None] = ...,
    ) -> None: ...
    def applyLocalizedPattern(self, pattern: Union[str, unicode]) -> None: ...
    def applyPattern(self, pattern: Union[str, unicode]) -> None: ...
    ...
    def toLocalizedPattern(self) -> Union[str, unicode]: ...
    def toPattern(self) -> Union[str, unicode]: ...
