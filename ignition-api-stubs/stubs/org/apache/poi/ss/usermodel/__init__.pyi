...
class Cell:
    ...
    def getCellFormula(self) -> Union[str, unicode]: ...
    ...
    def getStringCellValue(self) -> Union[str, unicode]: ...
    ...
    def setCellFormula(self, formula: Union[str, unicode]) -> None: ...
...
class CellRange:
    ...
    def getReferenceText(self) -> Union[str, unicode]: ...
...
class CellStyle:
    ...
    def getDataFormatString(self) -> Union[str, unicode]: ...
...
class Comment:
    def getAddress(self) -> CellAddress: ...
    def getAuthor(self) -> Union[str, unicode]: ...
    ...
    def setAuthor(self, author: Union[str, unicode]) -> None: ...
...
class ConditionalFormattingRule:
    ...
    def getFormula1(self) -> Union[str, unicode]: ...
    def getFormula2(self) -> Union[str, unicode]: ...
    ...
    def getText(self) -> Union[str, unicode]: ...
...
class ConditionalFormattingThreshold:
    ...
    def getFormula(self) -> Union[str, unicode]: ...
    def getRangeType(self) -> ConditionalFormattingThreshold.RangeType: ...
    def getValue(self) -> float: ...
    def setFormula(self, formula: Union[str, unicode]) -> None: ...
    def setRangeType(
...
class CreationHelper:
    ...
    def createRichTextString(self, text: Union[str, unicode]) -> RichTextString: ...
...
class DataFormat:
    def getFormat(self, arg: Union[int, str, unicode]) -> int: ...
...
class DataValidation:
    ...
    def createErrorBox(
        self, title: Union[str, unicode], text: Union[str, unicode]
    ) -> None: ...
    def createPromptBox(
        self, title: Union[str, unicode], text: Union[str, unicode]
    ) -> None: ...
    def getEmptyCellAllowed(self) -> bool: ...
    def getErrorBoxText(self) -> Union[str, unicode]: ...
    def getErrorBoxTitle(self) -> Union[str, unicode]: ...
    def getErrorStyle(self) -> int: ...
    def getPromptBoxText(self) -> Union[str, unicode]: ...
    def getPromptBoxTitle(self) -> Union[str, unicode]: ...
...
class DataValidationConstraint:
    class OperatorType(Object):
        ...
        def validateSecondArg(
            self, comparisonOperator: int, paramValue: Union[str, unicode]
        ) -> None: ...
    ...
    def getExplicitListValues(self) -> List[Union[str, unicode]]: ...
    def getFormula1(self) -> Union[str, unicode]: ...
    def getFormula2(self) -> Union[str, unicode]: ...
    def getOperator(self) -> int: ...
    def getValidationType(self) -> int: ...
    def setExplicitListValues(
        self, explicitListValues: List[Union[str, unicode]]
    ) -> None: ...
    def setFormula1(self, formula: Union[str, unicode]) -> None: ...
    def setFormula2(self, formula: Union[str, unicode]) -> None: ...
    def setOperator(self, operator: int) -> None: ...

class DataValidationHelper:
    def createCustomConstraint(
        self, formula: Union[str, unicode]
    ...
    def createExplicitListConstraint(
        self, listOfValues: List[Union[str, unicode]]
    ) -> DataValidationConstraint: ...
    def createFormulaListConstraint(
        self, listFormula: Union[str, unicode]
    ) -> DataValidationConstraint: ...
...
class DateUtil(Object):
    ...
    @staticmethod
    def convertTime(timeStr: Union[str, unicode]) -> float: ...
    @staticmethod
    def getExcelDate(
    ...
    @staticmethod
    def parseDateTime(str_: Union[str, unicode]) -> float: ...
    @staticmethod
    def parseYYYYMMDDDate(dateStr: Union[str, unicode]) -> float: ...
    @staticmethod
    def setCalendar(
        calendar: Calendar,
        wholeDays: int,
...
class Font:
    ...
    def getFontName(self) -> Union[str, unicode]: ...
    ...
    def setFontName(self, name: Union[str, unicode]) -> None: ...
...
class HeaderFooter:
    def getCenter(self) -> Union[str, unicode]: ...
    def getLeft(self) -> Union[str, unicode]: ...
    def getRight(self) -> Union[str, unicode]: ...
    def setCenter(self, newCenter: Union[str, unicode]) -> None: ...
    def setLeft(self, newLeft: Union[str, unicode]) -> None: ...
    def setRight(self, newRight: Union[str, unicode]) -> None: ...
...
class FormulaEvaluator:
    ...
    def setupReferencedWorkbooks(
        self, workbooks: Dict[Union[str, unicode], FormulaEvaluator]
    ) -> None: ...
...
class IconMultiStateFormatting:
    class IconSet(Enum):
        ...
        @staticmethod
        def byName(name: Union[str, unicode]) -> IconMultiStateFormatting.IconSet: ...
        @staticmethod
...
class Name:
    def getComment(self) -> Union[str, unicode]: ...
    def getNameName(self) -> Union[str, unicode]: ...
    def getRefersToFormula(self) -> Union[str, unicode]: ...
    def getSheetIndex(self) -> int: ...
    def getSheetName(self) -> Union[str, unicode]: ...
    def isDeleted(self) -> bool: ...
    def isFunctionName(self) -> bool: ...
    def setComment(self, comment: Union[str, unicode]) -> None: ...
    def setFunction(self, value: bool) -> None: ...
    def setNameName(self, name: Union[str, unicode]) -> None: ...
    def setRefersToFormula(self, formulaText: Union[str, unicode]) -> None: ...
    def setSheetIndex(self, sheetId: int) -> None: ...

class Shape:
    def getAnchor(self) -> ChildAnchor: ...
    def getParent(self) -> Shape: ...
    def getShapeName(self) -> Union[str, unicode]: ...
...
class Picture(Shape):
    ...
    def getSheet(self) -> Sheet: ...
    def resize(self, *args: Any) -> Union[str, unicode]: ...
...
class PictureData:
    ...
    def getMimeType(self) -> Union[str, unicode]: ...
    def getPictureType(self) -> int: ...
    def suggestFileExtension(self) -> Union[str, unicode]: ...
...
class RichTextString:
    ...
    def getString(self) -> Union[str, unicode]: ...
    def length(self) -> int: ...
...
class ObjectData(SimpleShape):
    ...
    def getFileName(self) -> Union[str, unicode]: ...
    def getObjectData(self) -> bytearray: ...
    def getOLE2ClassName(self) -> Union[str, unicode]: ...
    def getPictureData(self) -> PictureData: ...
...
class Sheet:
    ...
    def protectSheet(self, password: Union[str, unicode]) -> None: ...
    ...
    def setArrayFormula(
        self, formula: Union[str, unicode], range: CellRangeAddress
    ) -> CellRange: ...
...
class Workbook(Closeable):
    ...
    def addOlePackage(
        self,
        oleData: bytearray,
        label: Union[str, unicode],
        fileName: Union[str, unicode],
        command: Union[str, unicode],
    ) -> int: ...
    ...
    def createSheet(self, name: Union[str, unicode, None] = ...) -> Sheet: ...
    def findFont(
        self,
        bold: bool,
        color: int,
    ...
    def getName(self, name: Union[str, unicode]) -> Name: ...
    ...
    def getPrintArea(self) -> Union[str, unicode]: ...
    def getSheet(self, name: Union[str, unicode]) -> Sheet: ...
    def getSheetAt(self, index: int) -> Sheet: ...
    def getSheetIndex(self, arg: Union[str, unicode, Sheet]) -> int: ...
    def getSheetName(self, sheet: int) -> Union[str, unicode]: ...
    ...
    def linkExternalWorkbook(
        self, name: Union[str, unicode], workbook: Workbook
    ) -> None: ...
    ...
    def setPrintArea(self, sheetIndex: int, *args: Union[str, unicode]) -> None: ...
    def setSelectedTab(self, index: int) -> None: ...
    def setSheetHidden(self, sheetIx: int, hidden: bool) -> None: ...
    def setSheetName(self, sheet: int, name: Union[str, unicode]) -> None: ...
    def setSheetOrder(self, sheetName: Union[str, unicode], pos: int) -> None: ...
...
class ExcelNumberFormat(Object):
    id: int
    format: Union[str, unicode]
    def __init__(self, idx: int, format_: Union[str, unicode]) -> None: ...
    def getIdx(self) -> int: ...
...
class ExtendedColor(Object, Color):
    ...
    def getARGBHex(self) -> Union[str, unicode]: ...
    def getIndex(self) -> int: ...
    ...
    def setARGBHex(self, argb: Union[str, unicode]) -> None: ...
...
class CellValue(Object):
    ...
    def getStringValue(self) -> Union[str, unicode]: ...
    @staticmethod
