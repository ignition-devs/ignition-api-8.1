...
class ApplicationScope(Object):
    ...
    @staticmethod
    def getScopePrefix() -> Union[str, unicode]: ...
    @staticmethod
    ...
    @staticmethod
    def parseScope(s: Union[str, unicode]) -> int: ...
    @staticmethod
    def toCode(scope: int) -> Union[str, unicode]: ...
...
class Version(Object):
    ...
    def getXML(self) -> str: ...
    def isDev(self) -> bool: ...
    def isFutureVersion(self, arg: Union[str, unicode, Version]) -> bool: ...
    def isSnapshot(self) -> bool: ...
    @staticmethod
    def parse(s: Union[str, unicode]) -> Version: ...
