...
class FieldNamingStrategy:
    def translateName(self, arg: Any) -> Union[str, unicode]: ...
...
class FieldNamingPolicy(Enum, FieldNamingStrategy):
    IDENTITY: Union[str, unicode]
    UPPER_CAMEL_CASE: Union[str, unicode]
    UPPER_CAMEL_CASE_WITH_SPACES: Union[str, unicode]
    LOWER_CASE_WITH_UNDERSCORES: Union[str, unicode]
    LOWER_CASE_WITH_DASHES: Union[str, unicode]
    LOWER_CASE_WITH_DOTS: Union[str, unicode]
    def translateName(self, arg: Any) -> Union[str, unicode]: ...
...
class Gson(Object):
    ...
    def toJson(self, *args: Any) -> Union[str, unicode, None]: ...
...
class JsonObject(JsonElement):
    def add(self, property: Union[str, unicode], value: JsonElement) -> None: ...
    def addProperty(self, property: Union[str, unicode], value: Any) -> None: ...
    def createJsonElement(self, value: Object) -> JsonElement: ...
    def get(self, memberName: Union[str, unicode]) -> JsonElement: ...
    def getAsBigDecimal(self) -> float: ...
    def getAsBigInteger(self) -> int: ...
    def getAsBoolean(self) -> bool: ...
    def getAsByte(self) -> Any: ...
    ...
    def getAsNumber(self) -> Union[float, int, long]: ...
    def getAsShort(self) -> int: ...
    def has(self, memberName: Union[str, unicode]) -> bool: ...
    def remove(self, property: Union[str, unicode]) -> JsonElement: ...
    def size(self) -> int: ...
