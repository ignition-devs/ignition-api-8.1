...
def getAccounts():
    """Return a list of Twilio accounts that have been configured in
    the Gateway.
...
def getAccountsDataset():
    """Return a list of Twilio accounts that have been configured in
    the Gateway as a single-column Dataset.

    Returns:
        Dataset: A list of configured Twilio accounts as a
...
def getPhoneNumbers(accountName):
    ...
    Note that these numbers are supplied by Twilio, and are not
    defined on a user in Ignition.

    Args:
        accountName (str): The Twilio account to retrieve phone
            numbers for.

    Returns:
        list[str]: A list of phone numbers for the given Twilio
            account.
    """
    phoneNumbers = []
...
def getPhoneNumbersDataset(accountName):
    """Return a list of outgoing phone numbers for a Twilio account as
    a single-column Dataset. Note that these numbers are supplied by
    ...
    Returns:
        Dataset: A list of phone numbers for the given Twilio account
            as a single-column Dataset.
    """
    print accountName
    return Dataset()
