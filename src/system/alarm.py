...
def queryJournal(
    ...
    journalName=None,  # type: Union[str, unicode, None]
    priority=None,  # type: Optional[List[Union[str, unicode, int]]]
    state=None,  # type: Optional[List[Union[str, unicode, int]]]
    ...
    provider=None,  # type: Optional[List[Union[str, unicode]]]
):
