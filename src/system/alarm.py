...
class ShelvedPath(Object):
    ...
    "shelved", such as when it was shelved, and by whom, and the
    actual path."""
...
def listPipelines(projectName='alarm-pipelines'):
    ...
    Args:
        projectName (str): The project to check alarm pipelines for.
            If omitted, will look for a project named
            "alarm-pipelines".
