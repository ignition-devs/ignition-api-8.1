...
def format(date, format="yyyy-MM-dd HH:mm:ss"):
    ...
    _format = _format.replace("d", f"{_date.day}")
    _format = _format.replace("EEEE", "%A")
    _format = _format.replace("E", "%a")
    _format = _format.replace("F", f"{_date.isocalendar()[2]}")
    ...
    _format = _format.replace("M", f"{_date.month}")
    ...
    _format = _format.replace("w", f"{_date.isocalendar()[1] + 1}")
    _format = _format.replace("u", "%w")
    _format = _format.replace(
        "W",
        f"{_date.isocalendar()[1] - _date.replace(day=1).isocalendar()[1] + 1}",
    )
    ...
    _format = _format.replace("yyyy", f"{_date.year}")
