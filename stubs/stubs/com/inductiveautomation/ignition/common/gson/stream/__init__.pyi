...
class JsonReader(Object, Closeable):
    ...
    def nextName(self) -> Union[str, unicode]: ...
    def nextNull(self) -> None: ...
    def nextString(self) -> Union[str, unicode]: ...
...
class JsonWriter(Object, Closeable, Flushable):
    ...
    def isLenient(self) -> bool: ...
    def jsonValue(self, value: Union[str, unicode]) -> JsonWriter: ...
    def name(self, name: Union[str, unicode]) -> JsonWriter: ...
    def setHtmlSafe(self, htmlSafe: bool) -> None: ...
    def setIndent(self, indent: Union[str, unicode]) -> None: ...
    def setLenient(self, lenient: bool) -> None: ...
