...
class PyObject(Object):
    ...
    def asName(self, arg: Union[int, PyObject]) -> Union[str, unicode]: ...
    def asString(self, index: Optional[int] = ...) -> Union[str, unicode]: ...
    def asStringOrNull(self, index: Optional[int] = ...) -> Union[str, unicode]: ...
    ...
    def noAttributeError(self, name: Union[str, unicode]) -> None: ...
    @staticmethod
    def object___subclasshook__(type: PyType, subclass: PyObject) -> PyObject: ...
    def readonlyAttributeError(self, name: Union[str, unicode]) -> None: ...
...
class CodeFlag(Enum):
    ...
    @staticmethod
    def valueOf(name: Union[str, unicode]) -> CodeFlag: ...
    @staticmethod
...
class PyCode(PyObject):
    co_name: Union[str, unicode]
    def call(self, *args: Any) -> None: ...

class PyBaseCode(PyCode):
    co_argcount: int
    co_cellvars: List[Union[str, unicode]]
    co_filename: Union[str, unicode]
    co_firstlineno: int
    co_flags: CompilerFlags
    co_freevars: List[Union[str, unicode]]
    co_nlocals: int
    co_varnames: List[Union[str, unicode]]
    jy_npurecell: int
    varargs: bool
    varkwargs: bool
...
class PyException(RuntimeException):
    ...
    def exceptionClassName(self, obj: PyObject) -> Union[str, unicode]: ...
...
class PyFrame(PyObject):
    ...
    def delglobal(self, index: Union[str, unicode]) -> None: ...
    def dellocal(self, index: Union[int, str, unicode]) -> None: ...
    ...
    def getglobal(self, index: Union[str, unicode]) -> PyObject: ...
    def getLine(self) -> int: ...
    def getlocal(self, index: int) -> PyObject: ...
    def getLocals(self) -> PyObject: ...
    def getname(self, index: Union[str, unicode]) -> PyObject: ...
    def getTrace(self) -> PyObject: ...
    def refersDirectlyTo(self, ob: PyObject) -> bool: ...
    def setderef(self, index: int, value: PyObject) -> None: ...
    def setglobal(self, index: Union[str, unicode], value: PyObject) -> None: ...
    def setline(self, line: int) -> None: ...
    def setlocal(self, index: Union[int, str, unicode], value: PyObject) -> None: ...
...
class PySystemState(PyObject):
    ...
    def modules_reloading(self) -> Mapping[Union[str, unicode], PyModule]: ...
...
class PyTraceback(PyObject):
    ...
    def dumpStack(
        self, buf: Optional[StringBuilder] = ...
...
class PyType(PyObject):
    ...
    def compatibleForAssignment(
        self, other: PyType, attribute: Union[str, unicode]
    ) -> None: ...
    ...
    def fastGetName(self) -> Union[str, unicode]: ...
    @staticmethod
    ...
    def lookup_where(
        self, name: Union[str, unicode], where: List[PyObject]
    ) -> PyObject: ...
    def lookup(self, name: Union[str, unicode]) -> PyObject: ...
    ...
    def super_lookup(self, ref: PyType, name: Union[str, unicode]) -> PyObject: ...
    def traverse(self, visit: Visitproc, arg: Object) -> int: ...
