...
class EvaluationWorkbook:
    class ExternalName(Object):
        def __init__(
            self, nameName: Union[str, unicode], nameNumber: int, ix: int
        ) -> None: ...
        def getIx(self) -> int: ...
    ...
    class ExternalSheet(Object):
        def __init__(
            self, workbookName: Union[str, unicode], sheetName: Union[str, unicode]
        ) -> None: ...
        def getSheetName(self) -> Union[str, unicode]: ...
        def getWorkbookName(self) -> Union[str, unicode]: ...

    class ExternalSheetRange(Object):
        def __init__(
            self,
            workbookName: Union[str, unicode],
            firstSheetName: Union[str, unicode],
            lastSheetName: Union[str, unicode],
        ) -> None: ...
        def getFirstSheetName(self) -> Union[str, unicode]: ...
        def getLastSheetName(self) -> Union[str, unicode]: ...
    ...
    def getName(
        self, name: Union[str, unicode], sheetIndex: Optional[int] = ...
    ) -> ExternalName: ...
    def getSheet(self, sheetIndex: int) -> EvaluationSheet: ...
    def getSheetIndex(self, arg: Union[str, unicode, EvaluationSheet]) -> int: ...
    def getSheetName(self, sheetIndex: int) -> Union[str, unicode]: ...
    def getSpreadsheetVersion(self) -> SpreadsheetVersion: ...
    def getUDFFinder(self) -> UDFFinder: ...
    def resolveNameXText(self, ptg: NameXPtg) -> Union[str, unicode]: ...
...
class ExternSheetReferenceToken:
    def format2DRefAsString(self) -> Union[str, unicode]: ...
...
class SheetRangeEvaluator(Object, SheetRange):
    ...
    def getSheetName(self, sheetIndex: int) -> Union[str, unicode]: ...
    def getSheetNameRange(self) -> Union[str, unicode]: ...
...
class OperationEvaluationContext(Object):
    ...
    def findUserDefinedFunction(self, name: Union[str, unicode]) -> FreeRefFunction: ...
    ...
    def getDynamicReference(
        self,
        workbookName: Union[str, unicode],
        sheetName: Union[str, unicode],
        refStrPart1: Union[str, unicode],
        refStrPart2: Union[str, unicode],
        isA1Style: bool,
    ) -> ValueEval: ...
...
class WorkbookDependentFormula:
    def toFormulaString(self) -> Union[str, unicode]: ...
...
class WorkbookEvaluator(Object):
    ...
    def evaluateList(
        self,
        formula: Union[str, unicode],
        target: CellReference,
        region: CellRangeAddressBase,
    ) -> ValueEval: ...
    def findUserDefinedFunction(self, name: Union[str, unicode]) -> FreeRefFunction: ...
    @staticmethod
    def getNotSupportedFunctionNames() -> List[Union[str, unicode]]: ...
    @staticmethod
    def getSupportedFunctionNames() -> List[Union[str, unicode]]: ...
    ...
    def registerFunction(
        name: Union[str, unicode], func: Union[FreeRefFunction, Function]
    ) -> None: ...
...
class ConditionalFormattingEvaluator(Object):
    ...
    def getFormatRulesForSheet(
        self, sheet: Union[str, unicode, Sheet]
    ) -> List[EvaluationConditionalFormatRule]: ...
