...
class Pxg:
    ...
    def setSheetName(self, name: Union[str, unicode]) -> None: ...
...
class Pxg3D(Pxg):
    ...
    def getSheetName(self) -> Union[str, unicode]: ...
    def setLastSheetName(self, name: Union[str, unicode]) -> None: ...
    def setSheetName(self, name: Union[str, unicode]) -> None: ...
    def toFormulaString(self) -> Union[str, unicode]: ...
...
class Ptg(Object, Duplicatable):
    ...
    def getRVAType(self) -> Union[str, unicode]: ...
...
class NameXPxg(OperandPtg):
    ...
    def getSheetName(self) -> Union[str, unicode]: ...
    def setSheetName(self, sheetName: Union[str, unicode]) -> None: ...
